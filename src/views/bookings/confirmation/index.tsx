...
import TermsConditions from './StepTermsConditions'
...
const ConfirmationWizard = () => {
  ...
  const getStepContent = (step: number) => {
    switch (step) {
      case 0:
        return <StepDetails handleNext={handleNext} />
      case 1:
        return <StepAddress handleNext={handleNext} popperPlacement="bottom-start" />
      case 2:
        return <TermsConditions handleNext={handleNext} />
      case 3:
      ...
      <CardContent sx={{ py: 11.5 }}>
        <StepperWrapper>
          <Stepper
            ...
            connector={
              !smallScreen ? <Icon fontSize="1.5rem" icon={direction === 'ltr' ? 'tabler:chevron-right' : 'tabler:chevron-left'} /> : null
            }
          >
